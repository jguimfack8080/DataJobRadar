    ...
    <div className="mx-auto flex max-w-6xl flex-col gap-6">
      <header>
        ...
        <p className="text-sm text-muted-foreground">
          Klicken Sie eine Zeile an, um die Anzeigen des Unternehmens zu sehen.
        </p>
      </header>
      <Card>
        <CardHeader>
        ...
        <CardContent>
          ...
          {unternehmen.error && (
            <FehlerAnzeige meldung="Unternehmen konnten nicht geladen werden." />
          )}
          {!unternehmen.isLoading &&
            !unternehmen.error &&
            (!unternehmen.data || unternehmen.data.length === 0) && (
              <LeererZustand titel="Noch keine Unternehmensdaten vorhanden." />
            )}
          {!unternehmen.isLoading &&
            !unternehmen.error &&
            unternehmen.data &&
            unternehmen.data.length > 0 && (
